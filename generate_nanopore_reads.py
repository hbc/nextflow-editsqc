...
def generate_nanopore_reads(genome_fasta, genome_gff, plasmid_fasta, plasmid_gff, num_reads=2000, output_file="nanopore_reads.fastq"):
...
if __name__ == "__main__":
    ...
    output_file = "./nanopore_reads.fastq"
